...
**이 4.09 USDC 가 지금 풀 아래쪽의 매수벽 전부입니다.**

### USDC 는 어디에 있나

**우리 지갑 어디에도 없습니다.** 전부 **풀 컨트랙트 안**에 있습니다.

```
https://basescan.org/token/0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913?a=0xaC130b30C9Bf0a337FDB8259344C2d7b571B4E3d
```

그리고 그 금액은 **하나가 아니라 셋으로 나뉩니다.** 2026-08-27 실측입니다.

| 조각 | 금액 | 어떻게 꺼내나 |
|---|---|---|
| 유니스왑 몫 | **0.006818** | **못 꺼냅니다.** 프로토콜 수수료 (수수료의 1/6) |
| 우리 수수료 | **0.034092** | `collect` — **타임락 7일 예약** |
| 원금 (매도 대금) | **4.050081** | `decreaseLiquidity` — **타임락 7일 예약** |
| **풀 잔고 합계** | **4.090993** | |

**수수료는 5개 포지션 중 #5883905 하나에만 붙어 있습니다.** 거래가 그 구간에서만 일어났기 때문입니다.

🔴 **둘 다 7일 예약을 거칩니다.** 포지션 NFT가 타임락에 있어서 「자유롭게」가 아닙니다.
회수하면 [`TOKENOMICS.md`](TOKENOMICS.md) 의 규칙대로 **선언 시점과 실행 시점에 두 번** 씁니다.

**이 숫자는 거래가 생길 때마다 바뀝니다.** 위 링크에서 직접 보시는 쪽이 정확합니다.
